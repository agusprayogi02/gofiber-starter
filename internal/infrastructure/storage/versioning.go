...
func CreateFile(db *gorm.DB, fileHeader *multipart.FileHeader, entityType string, entityID uint, userID uint, userName string, dirPath string, config FileVersionConfig) (*File, error) {
